/*!
 * @file DFRobot_B_LUX_V30C.h
 * @brief Define a class of DFRobot_B_LUX_V30C.
 ...
 * @version  V1.0
 * @date  2020-12-03
 * @https://github.com/DFRobot/DFRobot_B_LUX_V30C
 */
#ifndef  _DFROBOT_B_LUX_V30C_H_
#define  _DFROBOT_B_LUX_V30C_H_
...
// ERROR CODES
#define DFRobot_B_LUX_V30_OK                          0
#define DFRobot_B_LUX_V30_ERROR_WIRE_REQUEST          -10

typedef unsigned int    uint;
class DFRobot_B_LUX_V30C{
public:
  #define ACK        0x00
  #define NACK       0x01
...
public:
   ...
   */
  DFRobot_B_LUX_V30C(uint8_t cEN, uint8_t scl = SCL, uint8_t sda = SDA);
/**
