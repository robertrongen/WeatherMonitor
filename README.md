...
Type=simple
User=robert
WorkingDirectory=/home/robert/skymonitor/safety-monitor
ExecStart=/home/robert/skymonitor/venv/bin/python /home/robert/skymonitor/safety-monitor/app.py
Restart=always
RestartSec=5
...
ExecStart=/home/robert/skymonitor/venv/bin/python /home/robert/skymonitor/safety-monitor/control.py
Restart=always
RestartSec=5
StandardOutput=journal
StandardError=inherit
