...
static const unsigned char DEVEUI[8] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77};

// Application EUI (8 bytes, little-endian format)
// Example: 00 AA BB CC DD EE FF 00
static const unsigned char APPEUI[8] = {0x00, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x00};

// Application Key (16 bytes)
// Example: 11 22 33 44 55 66 77 88 99 AA BB CC DD EE FF 00
static const unsigned char APPKEY[16] = {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x00};
